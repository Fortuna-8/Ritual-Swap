import { type Config, type ResolvedRegister, type SwitchChainErrorType } from '@wagmi/core';
...
export type UseSwitchChainReturnType<config extends Config = Config, context = unknown> = Evaluate<UseMutationReturnType<SwitchChainData<config, config['chains'][number]['id']>, SwitchChainErrorType, SwitchChainVariables<config, config['chains'][number]['id']>, context> & {
